...
SOURCES = main.c mzapo_phys.c mzapo_parlcd.c snake.c utils.c display.c serialize_lock.c menu.c leds.c menu_utils.c
SOURCES += font_prop14x16.c font_rom8x16.c
TARGET_EXE = snake_game
...
SSH_OPTIONS=-o 'ProxyJump=manurmat@postel.felk.cvut.cz'
